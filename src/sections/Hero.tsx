        ...
        <div className="mb-16">
          ...
          <p className="text-3xl md:text-4xl text-gray-300 mt-8 whitespace-nowrap flex justify-center">
            ...
            <TextShimmer
              ...
              duration={2.5}
              spread={3}
              className="ml-2 italic font-bold text-3xl md:text-4xl [--base-color:theme(colors.blue.700)] [--base-gradient-color:theme(colors.blue.400)] dark:[--base-color:theme(colors.blue.700)] dark:[--base-gradient-color:theme(colors.white)]"
            >
              Easy
            </TextShimmer>
          </p>
